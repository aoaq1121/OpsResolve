      ...
      >
        ...
        <div style={{ background: "#f8fafc", border: "1.5px solid #e2e8f0", borderRadius: 10, padding: "14px 16px", marginBottom: 16 }}>
          ...
          {reasonPoints.length > 1 ? (
            <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 10 }}>
              {reasonPoints.map((point, i) => (
                <div key={i} style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
                  <span style={{ fontSize: 12, fontWeight: 700, color: "#475569", minWidth: 58, paddingTop: 1 }}>
            ...
            <div style={{ fontSize: 14, fontWeight: 600, color: "#0f1923", marginBottom: 10, lineHeight: 1.4 }}>
          ...
          {recommendationPoints.length > 1 ? (
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {recommendationPoints.map((point, i) => (
                <div key={i} style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
                  <span style={{ fontSize: 12, fontWeight: 700, color: "#16a34a", minWidth: 58, paddingTop: 1 }}>
                    {["Action", "Step", "Note", "Risk", "Next"][i] || "Step"}:
                  </span>
